    ...
    <head>
        ...
        <script>
            function myFunction(){
                ...
                const isLoggedIn = urlParams.get('l');              
                if(isLoggedIn) {
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="assets/img/logo/auto-apply.jpeg" alt="" style="
                    width: 215px;
                ">
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="menu-wrapper">
                                ...
                                <div class="header-btn f-right" id="islogged" style="display: block;">
                                    <span class="" style="padding-right: 25px;" id="loggeduser">Hi </span>
                                    <a href="#" class="btn head-btn2" id="autoApply">Auto Apply</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
