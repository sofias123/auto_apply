...
class autoapply:
    def __init__(self):
        try:
            ...
            self.driver.get("http://localhost/autoapply/")
            prYellow("Trying to log in autoapply.")
        ...
        try:    
            ...
            prRed("Couldnt log in autoapply.")
    ...
    def generateUrls(self):
        ...
        try: 
            with open('data/urlData.txt', 'w',encoding="utf-8" ) as file:
                autoapplyJobLinks =  self.driver..generateUrlLinks()
                for url in autoapplyJobLinks:
                    file.write(url+ "\n")
        ...
        for url in urlData:        
            ...
            for page in range(totalPages):
                ...
                for jobID in offerIds:
                    offerPage = 'http://localhost/autoapply/job_details/' + str(jobID)
